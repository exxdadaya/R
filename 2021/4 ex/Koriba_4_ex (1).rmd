...
plot(2:50, MSE.knn, type = 'b', col = 'darkgreen',
     xlab = 'значение k', ylab = 'MSE на тестовой выборке', ylim = c(6, 10))
# ошибка регрессии
...
Как можно видеть по графику, ошибка регрессии на тестовой выборке меньше, чем ошибка метода k ближайших соседей с k от 2 и далее с увеличением количества соседей точность kNN остается примно на одном уровне. Ошибка регрессионной модели на тестовой выборке не велика и составляет

$$\frac{\sqrt{MSE_{TEST}}}{\bar{y}_{TEST}} = 21.2 % $$ 
